    ...
    >
      ...
      >
        ...
        <SectionHeader
          ...
          heading="About Me"
          description="Create digital experiences with passion, detail and love"
          showUnderline={true}
          centered={true}
        />
                ...
                <div className="space-y-4 md:space-y-6">
                  <div>
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-gray-900 dark:text-white flex items-center gap-2 md:gap-3">
                      ...
                      Hello, I&apos;m Ana Belén Zúñiga 
                    </h3>
                    <p className="text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-4 md:mb-6">
                      A passionate <span className="font-bold text-blue-600 dark:text-blue-400">Frontend Engineer</span> with
                      <span className="font-bold text-green-600 dark:text-green-400"> 4+ years</span> building web and mobile applications with 
                      modern technologies.
                    </p>
                  </div>
                  ...
                  <div className="border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    ...
                    <div className="flex flex-wrap gap-2 md:gap-3">
                      {["Angular", "React", "Next.js", "TypeScript", "Node.js", "React Native", "Drupal", "WordPress", "UI/UX Design", "GraphQL/REST"].map((skill, index) => (
                        <motion.span
                          key={skill}
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-base md:text-lg">Frontend Engineer</h4>
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                    I’ve contributed to impactful projects for both the public and private sectors, working on everything 
                  from informative websites to complex applications
                  </p>
                </motion.div>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4 space-y-6 mt-6 lg:mt-0">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/90 to-pink-50/90 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3">
                <motion.a
                  href="mailto:anab1996@gmail.com"
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white break-all">anab1996@gmail.com</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">Costa Rica</div>
                  </div>
                </motion.div>
              </div>
            </div>
